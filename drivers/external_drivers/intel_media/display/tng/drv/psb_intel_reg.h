...
#define IS_I830(dev) ((dev)->pdev->device == PCI_DEVICE_ID_INTEL_82830_CGC)
#define IS_845G(dev) ((dev)->pdev->device == PCI_DEVICE_ID_INTEL_82845G_IG)
#define IS_I85X(dev) ((dev)->pdev->device == PCI_DEVICE_ID_INTEL_82855GM_IG)
#define IS_I855(dev) ((dev)->pdev->device == PCI_DEVICE_ID_INTEL_82855GM_IG)
#define IS_I865G(dev) ((dev)->pdev->device == PCI_DEVICE_ID_INTEL_82865_IG)


/* || dev->pdev->device == PCI_DEVICE_ID_INTELPCI_CHIP_E7221_G) */
#define IS_I915G(dev) (dev->pdev->device == PCI_DEVICE_ID_INTEL_82915G_IG)
#define IS_I915GM(dev) ((dev)->pdev->device == PCI_DEVICE_ID_INTEL_82915GM_IG)
#define IS_I945G(dev) ((dev)->pdev->device == PCI_DEVICE_ID_INTEL_82945G_IG)
#define IS_I945GM(dev) ((dev)->pdev->device == PCI_DEVICE_ID_INTEL_82945GM_IG)
...
#define IS_I965GM(dev) ((dev)->pdev->device == 0x2A02)
