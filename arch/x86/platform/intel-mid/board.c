...
#include "device_libs/platform_lps22hb.h"
/* SW devices */
...
struct devs_id __initconst device_ids[] = {
	...
	{"lps22hb", SFI_DEV_TYPE_I2C, 0, &lps22hb_platform_data, NULL},
	...
	/* Panel */
	{"PANEL_CMI_CMD", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"PANEL_JDI_VID", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"PANEL_JDI_CMD", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	/*  above 3 items will be removed
	* after firmware changing
	*/
	{"PNC_CMI_7x12", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"PNV_JDI_7x12", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"PNC_JDI_7x12", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"PNC_SHARP_10x19", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"PNV_SHARP_10x19", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"PNCD_SHARP_10x19", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"PNV_SHARP_25x16", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"PNC_SHARP_25x16", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"PNV_JDI_25x16", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"PNC_JDI_25x16", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"PNC_SDC_16x25", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"PNC_SDC_25x16", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"AUO_CMD", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"TIANMA_CMD", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"INNOLUX_CMD", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"AUO_CMD_4x4", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"AUO_CMD_39x39", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	{"HIMAX_CMD", SFI_DEV_TYPE_DISPLAY, 0, &no_platform_data,
		&panel_handler},
	...
	{"sst_ics43432", SFI_DEV_TYPE_IPC, 1, &merfld_sst_ics43432_audio_platform_data,
						&ipc_device_handler},
